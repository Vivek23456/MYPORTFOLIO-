...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function clickSplat(pointer) {
      ...
      color.r *= 15.0;  // Even brighter on click
      color.g *= 15.0;  // Even brighter on click
      color.b *= 15.0;  // Even brighter on click
      let dx = 50 * (Math.random() - 0.5);  // Bigger splash
      let dy = 50 * (Math.random() - 0.5);  // Bigger splash
    ...
    function generateColor() {
      ...
      c.r *= 0.8;  // Much more visible
      c.g *= 0.8;  // Much more visible
      c.b *= 0.8;  // Much more visible
      return c;
    }
  ...
  return (
    <div className="fixed top-0 left-0 z-10 pointer-events-none">
      <canvas ref={canvasRef} id="fluid" className="w-screen h-screen opacity-80" />
    </div>
  );
}
